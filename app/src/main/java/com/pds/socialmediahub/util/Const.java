...
public class Const {
    ...
    public static final String channelName = "Whats Delete";
    ...
    public static final String FIREBASE_SKIP_BUTTON = "AN_Skip_button";


    public static final String FIREBASE_SPLASH_LAUNCH = "splash_launch";
    public static final String FIREBASE_HISTORYFRAGMENT = "HistoryFragments";

    //tool bar buttons clicks
    ...
    //callredo
    public static final String FIREBASE_CALLREDO_AFTERCALL_PAGE_INAPP = "AN_FIREBASE_CALLREDO_AFTERCALL_PAGE_INAPP";
    public static final String FIREBASE_CALLREDO_AFTERCALL_PAGE_DOWNLOADED_STATUS_PAGE = "AN_FIREBASE_CALLREDO_AFTERCALL_PAGE_DOWNLOADED_STATUS_PAGE";
    public static final String FIREBASE_CALLREDO_AFTERCALL_PAGE_DELETED_MESSAGE_PAGE = "AN_FIREBASE_CALLREDO_AFTERCALL_PAGE_DELETED_MESSAGE_PAGE";
    public static final String FIREBASE_CALLREDO_AFTERCALL_SHARE_YOUR_VIDEO_STORY_PAGE = "AN_FIREBASE_CALLREDO_AFTERCALL_SHARE_YOUR_VIDEO_STORY_PAGE";
}
