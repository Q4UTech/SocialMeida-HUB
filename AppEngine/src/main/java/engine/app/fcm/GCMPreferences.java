...
public class GCMPreferences {
    ...
    public String getSplashName() {
        return preferences.getString("SplashName", "");
    }

    public void setSplashName(String flag) {
        editor.putString("SplashName", flag);
        editor.commit();
    }

    public String getDashboardName() {
        return preferences.getString("DashboardName", "");
    }

    public void setDashboardName(String flag) {
        editor.putString("DashboardName", flag);
        editor.commit();
    }

    public String getTransLaunchName() {
        return preferences.getString("TransLaunch", "TransLaunchFullAdsActivity");
    }

    public void setTransLaunchName(String flag) {
        editor.putString("TransLaunch", flag);
        editor.commit();
    }

    public String getPurchaseJSON() {
        return preferences.getString("savePurchaseJSON", null);
    }

    public void savePurchaseJSON(String flag) {
        editor.putString("savePurchaseJSON", flag);
        editor.commit();
    }

    public String getFirsttimeString() {
        return preferences.getString("getFirsttimeString", "true");
    }

    //
    public void setFirsttimeString(String flag) {
        editor.putString("getFirsttimeString", flag);
        editor.commit();
    }

    public int getLocalisationLang() {
        return preferences.getInt("KEY_LOCALISATION_LANG", 0);
    }

    public void setLocalisationLang(int value) {
        editor.putInt("KEY_LOCALISATION_LANG", value);
        editor.commit();
    }

    public String getLaunchCount() {
        return preferences.getString("KEY_APP_LAUNCH_COUNT", "1");
    }

    public void setLaunchCount(String value) {
        editor.putString("KEY_APP_LAUNCH_COUNT", value);
        editor.commit();
    }
}