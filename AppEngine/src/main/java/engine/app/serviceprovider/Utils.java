...
public class Utils {
    ...
    public static void applyFirebaseAnalytics(Context context, String bundleName) {
        Bundle bundle = new Bundle();
        bundle.putString(bundleName, bundleName);
        FirebaseAnalytics.getInstance(context).logEvent(bundleName, bundle);
    }
    ...
    @RequiresApi(api = Build.VERSION_CODES.DONUT)
    public void sendFeedbackForFAQ(Context context) {
        Intent emailIntent = new Intent(Intent.ACTION_SEND);
        emailIntent.putExtra(Intent.EXTRA_EMAIL, new String[]{Slave.FEEDBACK_email});
        emailIntent.putExtra(Intent.EXTRA_SUBJECT, "FeedBack");
        emailIntent.setType("text/plain");
        emailIntent.putExtra(Intent.EXTRA_TEXT, ""
                + "Write your issue/query here : " + "\n"
                + "\n"
                + "\n"
                + "\n"
                + context.getResources().getString(R.string.app_name) + "\n"
    ...
    public void rateApps(Context context) {
        try {
            Intent browserIntent = new Intent(Intent.ACTION_VIEW,
                    Uri.parse(Slave.RATE_APP_rateurl));
            browserIntent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
    ...
    public void showSharePrompt(final Context context, String msg) {
        AlertDialog.Builder dia = new AlertDialog.Builder(context, R.style.MyDialogTheme)
                .setTitle(context.getApplicationContext()
    ...
    public void showFeedbackPrompt(final Context context, String msg) {
        AlertDialog.Builder dia = new AlertDialog.Builder(context,R.style.MyDialogTheme).setTitle("Thanks for using " + context.getApplicationContext()
                .getResources().getString(R.string.app_name))
                .setMessage(msg)
  ...
  /*  public static void sortProviderList(final List<AdsProviders> list) {
     ...
     */
    public static void setOpenAdsCount_start(Activity activity, int data) {
    ...
    public static int getOpenAdsCount_start(Activity cActivity) {
