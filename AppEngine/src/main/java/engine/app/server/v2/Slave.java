...
public class Slave {
    ...
    //For Applovin mediation tags
    public static final String Provider_ApplovinMax_Mediation_Full_Ads = "ApplovinMax_Mediation_Full_Ads";
    public static final String Provider_ApplovinMax_Mediation_Banner = "ApplovinMax_Mediation_Banner";
    public static final String Provider_ApplovinMax_Mediation_Native_Large = "ApplovinMax_Mediation_Native_Large";
    public static final String Provider_ApplovinMax_Mediation_Native_Mid = "ApplovinMax_Mediation_Native_Mid";
    public static final String Provider_ApplovinMax_Mediation_Banner_Rect = "ApplovinMax_Mediation_Banner_Rect";
    ...
    public static final String Provider_AppNext_Suggested_Banner_Ads = "Suggested_Banner_Ads";
    ...
    public static String RATE_APP_appurl = "";
    ...
    public static String MOREAPP_moreurl = "";
