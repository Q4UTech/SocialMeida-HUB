...
public class DataHubPreference {
    ...
    public String getAppVersion() {
        return preferences.getString("_application_version", DataHubConstant.KEY_NA);
    }

    public void setAppVersion(String version) {
        editor.putString("_application_version", version);
        editor.commit();
    }
    ...
    public int getCdoCount() {
        int count = preferences.getInt("_cdo_count_3", 0);
        return count;
    }

    public void setCdoCount(int count) {
        editor.putInt("_cdo_count_3", count);
        editor.commit();
    }
