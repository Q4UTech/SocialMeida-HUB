...
public class EngineClient {
    ...
    private String fcmToken, _notificationID;
    ...
    void setNotificationID(String _id) {
    ...
    void setInAppData(String productID) {
    ...
    private JSONObject getJsonObject(Object obj) throws JSONException {
        ...
        if (responseType == EngineApiController.VERSION_ID_CODE) {
            ...
            NotificationIDData notiData = new NotificationIDData(_notificationID);
        ...
        } else if (responseType == EngineApiController.INAPP_CODE) {
            InAppRequest iData = new InAppRequest(weakReference.get(), productID);
            ...
            String jsonObject = gson.toJson(obj);
            PrintLog.print("printing INAPP_CODE " + " " + jsonObject);
            return new JSONObject(jsonObject);
        }
